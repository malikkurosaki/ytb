...
let body = $(document.body).html('<div></div>');
let conten = $('<div class="d-flex flex-row "></div>');
let gambar = $(`<div class="col-md-6 col-sm-12 col-xs-12" id="gambar"></div>`);
let log = $(`<div class="col-md-6 col-sm-12 col-xs-12" id="log"></div>`);
